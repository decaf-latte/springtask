...
public class PostingController {
  ...
  public ResponseDto<List<Posting>> getPosting() {
    ...
    try {
      ...
      return new ResponseDto<List<Posting>>(null, ErrorCode.INVALID_ERROR);
    }
    return new ResponseDto<List<Posting>>(data);
  }
  ...
  public ResponseDto<Boolean> deletePosting(@PathVariable Long id) {
    try {
      ...
      return new ResponseDto<>(false, ErrorCode.ENTITY_NOT_FOUND);
    }
